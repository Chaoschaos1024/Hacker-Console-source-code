...
#define GT911_ADDR1 (uint8_t)0x5D  //93
#define GT911_ADDR2 (uint8_t)0x14  //20
...
class GT911 {
public:
  GT911(uint8_t _sda, uint8_t _scl, uint8_t _int, uint8_t _rst, uint16_t _width, uint16_t _height);
